...
_lr_signature = 'codeblockLANGLE LCURLY LROUND LSQUARE NEWLINE RANGLE RCURLY RROUND RSQUAREcodeblock : linecodeblock : codeblock lineline : chunks NEWLINEchunks : chunkchunks : chunks chunkchunks : error chunk\n    chunk : LROUND RROUND\n             | LSQUARE RSQUARE\n             | LANGLE RANGLE\n             | LCURLY RCURLY\n    chunk : LROUND chunks RROUND\n             | LSQUARE chunks RSQUARE\n             | LANGLE chunks RANGLE\n             | LCURLY chunks RCURLY\n    '
...
_lr_productions = [
  ...
  ('codeblock -> line','codeblock',1,'p_program1','parser.py',71),
  ('codeblock -> codeblock line','codeblock',2,'p_program2','parser.py',77),
  ('line -> chunks NEWLINE','line',2,'p_line','parser.py',84),
  ('chunks -> chunk','chunks',1,'p_chunks','parser.py',90),
  ('chunks -> chunks chunk','chunks',2,'p_chunks2','parser.py',95),
  ('chunks -> error chunk','chunks',2,'p_chunk_error','parser.py',100),
  ('chunk -> LROUND RROUND','chunk',2,'p_chunk1','parser.py',107),
  ('chunk -> LSQUARE RSQUARE','chunk',2,'p_chunk1','parser.py',108),
  ('chunk -> LANGLE RANGLE','chunk',2,'p_chunk1','parser.py',109),
  ('chunk -> LCURLY RCURLY','chunk',2,'p_chunk1','parser.py',110),
  ('chunk -> LROUND chunks RROUND','chunk',3,'p_chunk2','parser.py',116),
  ('chunk -> LSQUARE chunks RSQUARE','chunk',3,'p_chunk2','parser.py',117),
  ('chunk -> LANGLE chunks RANGLE','chunk',3,'p_chunk2','parser.py',118),
  ('chunk -> LCURLY chunks RCURLY','chunk',3,'p_chunk2','parser.py',119),
]
